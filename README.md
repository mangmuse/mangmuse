...
|프로젝트|설명|링크|
|----------|------|------|
| **PRS** |프롬프트 품질 관리 및 회귀 분석 플랫폼| [Frontend](https://github.com/mangmuse/prs-frontend)·[Backend](https://github.com/mangmuse/prs-backend) |
| **RT-Fact** |AI 기반 실시간 팩트체크 서비스| [Frontend](https://github.com/mangmuse/RT-Fact-FE)·[Backend](https://github.com/mangmuse/RT-Fact-be)·[MCP](https://github.com/mangmuse/RT-Fact-MCP) |
| **Fit-planner** |운동 루틴 관리 PWA| [App](https://github.com/mangmuse/fit-planner) |
